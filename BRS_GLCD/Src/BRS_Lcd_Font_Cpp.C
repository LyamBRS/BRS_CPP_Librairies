...
//#include "GLcd.h"
//#include "math.h"
#include "BRS_Lcd_Font_Cpp.h"


// 1234 
void Line4(unsigned char x, unsigned char y, unsigned char Hex, unsigned char state)
{
 BRS::LCD::Draw::Pixel(x+3,y, ((Hex & 0x01))    == state); 
 BRS::LCD::Draw::Pixel(x+2,y, ((Hex & 0x02)>>1) == state); 
 BRS::LCD::Draw::Pixel(x+1,y, ((Hex & 0x04)>>2) == state); 
 BRS::LCD::Draw::Pixel(x  ,y, ((Hex & 0x08)>>3) == state);   
}
